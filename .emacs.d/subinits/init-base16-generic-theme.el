...
;; font-lock
   ...
   (font-lock-keyword-face                       :foreground base0A)
   ...
   (font-lock-type-face                          :foreground base0E)
...
;; nlinum-relative-mode
   (line-number-current-line                     :foreground base0A :background fringe-bg)
...
;; rainbow-delimiters
   ...
   (rainbow-delimiters-unmatched-face            :forgeround base00 :background base08)
   (rainbow-delimiters-mismatched-face           :forgeround base00 :background base00)
...
(let ((base00 (plist-get base16-generic-colors :base00))
      (base01 (plist-get base16-generic-colors :base01))
      (base02 (plist-get base16-generic-colors :base02))
      (base03 (plist-get base16-generic-colors :base03))
      (base04 (plist-get base16-generic-colors :base04))
      (base05 (plist-get base16-generic-colors :base05))
      (base06 (plist-get base16-generic-colors :base06))
      (base07 (plist-get base16-generic-colors :base07))
      (base08 (plist-get base16-generic-colors :base08))
      (base09 (plist-get base16-generic-colors :base09))
      (base0A (plist-get base16-generic-colors :base0A))
      (base0B (plist-get base16-generic-colors :base0B))
      (base0C (plist-get base16-generic-colors :base0C))
      (base0D (plist-get base16-generic-colors :base0D))
      (base0E (plist-get base16-generic-colors :base0E))
      (base0F (plist-get base16-generic-colors :base0F)))
